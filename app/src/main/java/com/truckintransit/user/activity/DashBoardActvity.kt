...
class DashBoardActvity : BaseActivity(), ListnerForNaviagtionItem, ListnerForUserSelectPlace , OnMapReadyCallback,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val layoutManager_horizontal: RecyclerView.LayoutManager = LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL ,false)
        ...
        val layoutManager_horizontal1: RecyclerView.LayoutManager = LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL ,false)
        ...
        tv_book.setOnClickListener {
          ...
          launchActivity<RiderBookActivity>()
        }
    ...
    private fun startTrackingLocation() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this!!, arrayOf(Manifest.permission.ACCESS_FINE_LOCATION), REQUEST_LOCATION_PERMISSION_LOCATION)
        } else {
